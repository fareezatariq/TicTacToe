...
public class gameMechanics extends AppCompatActivity implements View.OnClickListener {
    ...
    public void performAction(ImageView imageView, int selectedBoxPosition){
        ...
        if (playerTurn==1){
            ...
            if(checkPlayerWin()){
                Dialog winDialog= new WinDialog(gameMechanics.this,playerOneName.getText().toString()+ " has won the match!", gameMechanics.this);
                winDialog.setCancelable(false);
                winDialog.show();
            }
            else if (totalSelectBoxes==9){
                Dialog winDialog= new WinDialog(gameMechanics.this,"It is a draw", gameMechanics.this);
                winDialog.setCancelable(false);
                winDialog.show();
            }
            else {
            ...
            if(checkPlayerWin()){
                Dialog winDialog= new WinDialog(gameMechanics.this,playerTwoName.getText().toString()+ " has won the match!", gameMechanics.this);
                winDialog.setCancelable(false);
                winDialog.show();
            }
            else if (totalSelectBoxes==9){
